...
export class Education {
  ...
  @Column({ type: 'jsonb', nullable: true }) minors: Array<{ type: string; name: string }> | null;
  @Column({ nullable: true }) degree: string;          // 학사/석사/박사/전문학사/고졸 등
  @Column({ type: 'numeric', precision: 4, scale: 2, nullable: true }) gpa: string;
  @Column({ type: 'numeric', precision: 4, scale: 2, nullable: true }) gpa_max: string;
