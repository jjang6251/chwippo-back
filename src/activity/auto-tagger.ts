...
const CAT_KEYWORDS: Record<LogCategory, string[]> = {
  develop: [
    'pr', '머지', '커밋', '코드', '리팩터', '버그', '개발', '구현', 'api',
    '디버깅', '배포', 'deploy', '백엔드', '프론트', '풀스택', 'devops', 'ml',
    '머신러닝', 'code review', '코드리뷰',
  ],
  meeting: [
    '회의', '미팅', '브리핑', '주간보고', 'standup', '스탠드업', '1on1', '1:1',
    '데일리',
  ],
  presentation: [
    '발표', '강연', '시연', '데모', '제안', '프레젠', 'pt', '컨퍼런스', '워크샵',
    '특강', '세미나',
  ],
  collaboration: [
    '협업', '팀원', '함께', '같이', '페어', 'pair', 'slack', '디스코드', '협력',
  ],
  conflict_resolution: [
    '갈등', '조율', '풀어', '해결', '중재', '트러블', '분쟁', '의견 충돌',
    '의견충돌',
  ],
  learning: [
    '배움', '학습', '읽음', '강의', '공부', '수강', '튜토리얼', '인강',
    '자격증 공부', '독학', 'course',
  ],
  leadership: [
    '리드', '운영', '관리', '주도', '주관', '리더', '회장', '회장단', 'lead',
    'pm', '매니징', '멘토', 'mentor', '튜터',
  ],
  volunteer: ['봉사', '도움', '기부', '자원봉사', '모금'],
  customer: [
    '고객', '손님', '클라이언트', '응대', 'cs', 'b2b', 'b2c', '영업', '매출',
    '신규고객',
  ],
  analysis: [
    '분석', '리서치', '조사', '데이터', '인터뷰', '설문', '통계', '지표', 'kpi',
    'roas', 'ctr', '퍼널', 'ut', 'ux 리서치', '사용자 조사', '사용자조사',
    '보고서', '인사이트',
  ],
  creative: [
    '기획', '디자인', '아이디어', '콘텐츠', '제작', '시안', '카피', '카피라이팅',
    '영상', '편집', '사진', '일러스트', '브랜딩', '로고', '아트워크',
    'wireframe', '와이어프레임',
  ],
  other: [],
};
...
const COMP_KEYWORDS: Record<LogComp, string[]> = {
  technical: ['코드', 'api', '개발', '기술', '구현', '리팩터', '백엔드', '프론트', 'ml', 'devops'],
  leadership: ['리드', '주도', '운영', '관리', '회장', 'lead', 'pm', '매니징', '멘토', '주관'],
  communication: ['발표', '설명', '소통', '협업', '프레젠', '브리핑', '제안'],
  planning: ['기획', '계획', '제안', '전략', '로드맵', '로드맵핑', '스프린트'],
  analytical: ['분석', '데이터', '리서치', '조사', '통계', '지표', 'kpi', '인사이트', 'ut'],
  problem_solving: ['해결', '풀어', '개선', '디버깅', '최적화', '트러블'],
  collaboration: ['협업', '팀원', '같이', '함께', '페어', '협력'],
  creativity: ['디자인', '아이디어', '창작', '콘텐츠', '시안', '브랜딩', '카피', '와이어프레임'],
